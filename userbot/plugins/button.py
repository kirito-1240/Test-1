...
@catub.cat_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [Tempest]<buttonurl:https://t.me/TempestNetwork:same> [support]<buttonurl:https://t.me/TempestUBSupport>",
    },
)
async def _(event):
...
@catub.cat_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test [google]<buttonurl:https://www.google.com> [Tempest]<buttonurl:https://t.me/TempestNetwork:same> [support]<buttonurl:https://t.me/TempestUBSupport>",
    },
)
async def _(event):
